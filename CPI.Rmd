...
With the standard P-value of 0.05, there is a significant difference between these two, but the amount is minuscule, with the bachelor's level having a barely smaller relative unemployment rate. 
